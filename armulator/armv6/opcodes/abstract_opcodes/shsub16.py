from armulator.armv6.bits_ops import to_signed, set_substring, substring, to_unsigned
from armulator.armv6.opcodes.opcode import Opcode


class Shsub16(Opcode):
    ...
    def execute(self, processor):
        if processor.condition_passed():
            ...
            d = set_substring(0, 15, 0, to_unsigned(diff1, 17) >> 1)
            d = set_substring(d, 31, 16, to_unsigned(diff2, 17) >> 1)
