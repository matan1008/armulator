from armulator.armv6.bits_ops import add_with_carry, lower_chunk, bit_not, bit_at
from armulator.armv6.opcodes.opcode import Opcode
from armulator.armv6.shift import shift


class RsbRegisterShiftedRegister(Opcode):
    ...
    def execute(self, processor):
        ...
        result, carry, overflow = add_with_carry(bit_not(processor.registers.get(self.n), 32), shifted, 1)
