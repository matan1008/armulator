...
class AddRegisterThumbT3(AddRegisterThumb):
    @staticmethod
    def from_bitarray(instr, processor):
        ...
        if rd == 13 or (rd == 15 and not setflags) or rn == 15 or rm in (13, 15):
            print('unpredictable')
        else:
            return AddRegisterThumbT3(instr, setflags=setflags, m=rm, d=rd, n=rn, shift_t=shift_t, shift_n=shift_n)
