...
class StrtA2(Strt):
    ...
    def from_bitarray(instr, processor):
        ...
        post_index = True
        if rn == 15 or rn == rt or rm or (arch_version() < 6 and rm == rn):
            print('unpredictable')
        else:
            return StrtA2(instr, register_form=True, add=add, post_index=post_index, t=rt, n=rn, m=rm, shift_t=shift_t,
                          shift_n=shift_n)
