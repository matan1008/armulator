from armulator.armv6.bits_ops import chain, substring, bit_at, bit_count
from armulator.armv6.opcodes.abstract_opcodes.ldm_thumb import LdmThumb


class LdmThumbT2(LdmThumb):
    @staticmethod
    def from_bitarray(instr, processor):
        ...
        if rn == 15 or bit_count(registers, 1, 16) < 2 or (p_m == 0b11) or (
            ...
            return LdmThumbT2(instr, wback=wback, registers=registers, n=rn)
