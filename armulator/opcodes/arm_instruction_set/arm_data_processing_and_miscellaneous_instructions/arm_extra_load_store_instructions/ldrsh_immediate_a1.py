from armulator.opcodes.abstract_opcodes.ldrsh_immediate import LdrshImmediate
from armulator.opcodes.opcode import Opcode


class LdrshImmediateA1(LdrshImmediate, Opcode):
    ...
    def from_bitarray(instr, processor):
        ...
        if rt.uint == 15 or (wback and rn.uint == rt.uint):
            ...
            return LdrshImmediateA1(instr, **{"add": add, "wback": wback, "index": index, "imm32": imm32,
                                              "t": rt.uint, "n": rn.uint})
