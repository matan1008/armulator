from armulator.opcodes.abstract_opcodes.cmp_register_shifted_register import CmpRegisterShiftedRegister
from armulator.opcodes.opcode import Opcode
from armulator.shift import decode_reg_shift


class CmpRegisterShiftedRegisterA1(CmpRegisterShiftedRegister, Opcode):
    def __init__(self, instruction, m, s, n, shift_t):
        Opcode.__init__(self, instruction)
        CmpRegisterShiftedRegister.__init__(self, m, s, n, shift_t)
