from armulator.opcodes.abstract_opcodes.sbc_register import SbcRegister
from armulator.opcodes.opcode import Opcode
from armulator.shift import decode_imm_shift


class SbcRegisterA1(SbcRegister, Opcode):
    ...
    def from_bitarray(instr, processor):
        ...
        return SbcRegisterA1(instr, **{"setflags": s, "m": rm.uint, "d": rd.uint, "n": rn.uint, "shift_t": shift_t,
                                       "shift_n": shift_n})
