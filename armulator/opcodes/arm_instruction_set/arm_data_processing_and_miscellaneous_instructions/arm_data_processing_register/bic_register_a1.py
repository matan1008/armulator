from armulator.opcodes.abstract_opcodes.bic_register import BicRegister
from armulator.opcodes.opcode import Opcode
from armulator.shift import decode_imm_shift


class BicRegisterA1(BicRegister, Opcode):
    ...
    def from_bitarray(instr, processor):
        ...
        return BicRegisterA1(instr, **{"setflags": s, "m": rm.uint, "d": rd.uint, "n": rn.uint, "shift_t": shift_t,
                                       "shift_n": shift_n})
