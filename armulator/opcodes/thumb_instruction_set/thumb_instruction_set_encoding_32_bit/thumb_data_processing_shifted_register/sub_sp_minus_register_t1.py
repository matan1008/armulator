from armulator.opcodes.abstract_opcodes.sub_sp_minus_register import SubSpMinusRegister
from armulator.opcodes.opcode import Opcode
from armulator.shift import decode_imm_shift, SRType


class SubSpMinusRegisterT1(SubSpMinusRegister, Opcode):
    ...
    def from_bitarray(instr, processor):
        ...
        if rd.uint == 13 and (shift_t != SRType.SRType_LSL or shift_n > 3) or (
            ...
            return SubSpMinusRegisterT1(instr, **{"setflags": setflags, "m": rm.uint,
