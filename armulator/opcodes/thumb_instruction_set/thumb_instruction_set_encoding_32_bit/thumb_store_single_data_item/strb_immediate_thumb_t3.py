from armulator.opcodes.abstract_opcodes.strb_immediate_thumb import StrbImmediateThumb
from armulator.opcodes.opcode import Opcode
from armulator.bits_ops import zero_extend
from armulator.arm_exceptions import UndefinedInstructionException


class StrbImmediateThumbT3(StrbImmediateThumb, Opcode):
    ...
    def from_bitarray(instr, processor):
        ...
        if rn == "0b1111" or (not index and not wback):
            ...
            return StrbImmediateThumbT3(instr, **{"add": add, "wback": wback, "index": index, "t": rt.uint,
