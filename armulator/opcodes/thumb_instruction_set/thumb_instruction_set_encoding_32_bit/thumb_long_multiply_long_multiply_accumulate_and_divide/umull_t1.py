from armulator.opcodes.abstract_opcodes.umull import Umull
from armulator.opcodes.opcode import Opcode


class UmullT1(Umull, Opcode):
    ...
    def from_bitarray(instr, processor):
        ...
        if rm.uint in (13, 15) or rn.uint in (13, 15) or rd_hi.uint in (13, 15) or rd_lo.uint in (
            ...
            return UmullT1(instr, **{"setflags": setflags, "m": rm.uint, "d_hi": rd_hi.uint, "d_lo": rd_lo.uint,
                                     "n": rn.uint})
