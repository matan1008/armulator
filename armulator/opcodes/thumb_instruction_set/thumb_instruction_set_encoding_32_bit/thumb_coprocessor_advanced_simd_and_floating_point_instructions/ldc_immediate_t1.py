...
class LdcImmediateT1(LdcImmediate, Opcode):
    ...
    def from_bitarray(instr, processor):
        ...
        if instr[7:11] == "0b0000":
            ...
            return LdcImmediateT1(instr, **{"cp": coproc.uint, "n": rn.uint, "add": add, "imm32": imm32, "index": index,
                                            "wback": wback})
