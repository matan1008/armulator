from armulator.opcodes.abstract_opcodes.and_immediate import AndImmediate
from armulator.opcodes.opcode import Opcode
from armulator.shift import thumb_expand_imm_c


class AndImmediateT1(AndImmediate, Opcode):
    ...
    def from_bitarray(instr, processor):
        ...
        if rd.uint == 13 or (rd.uint == 15 and not setflags) or rn.uint in (13, 15):
            ...
            return AndImmediateT1(instr, **{"setflags": setflags, "d": rd.uint, "n": rn.uint, "imm32": imm32,
                                            "carry": carry})
