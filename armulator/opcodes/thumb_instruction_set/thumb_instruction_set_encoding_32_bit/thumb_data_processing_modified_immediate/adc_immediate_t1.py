from armulator.opcodes.abstract_opcodes.adc_immediate import AdcImmediate
from armulator.opcodes.opcode import Opcode
from armulator.shift import thumb_expand_imm


class AdcImmediateT1(AdcImmediate, Opcode):
    ...
    def from_bitarray(instr, processor):
        ...
        if rd.uint in (13, 15) or rn.uint in (13, 15):
            ...
            return AdcImmediateT1(instr, **{"setflags": setflags, "d": rd.uint, "n": rn.uint, "imm32": imm32})
