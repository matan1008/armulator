...
class AsrImmediate(AbstractOpcode):
    def __init__(self, setflags, m, d, shift_n):
        super(AsrImmediate, self).__init__()
    ...
    def execute(self, processor):
        if processor.condition_passed():
            result, carry = shift_c(processor.core_registers.get(self.m), SRType.SRType_ASR, self.shift_n,
